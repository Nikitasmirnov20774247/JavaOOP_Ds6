...
public class ConsoleView implements View
{
    ...
    public ConsoleView(Scanner iScanner)
    {
    ...
    {
        System.out.print(message);
        if (iScanner.next().toLowerCase() == "y")
        {
            return true;
        }
        return false;
    ...
    public List<String> getListString(String message)
    {
        ...
        result.add(iScanner.next());
        for (String elem : iScanner.nextLine().split(" "))
        {
            if (elem != "")
            {
                result.add(elem);
